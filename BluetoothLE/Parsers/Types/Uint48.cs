...
namespace BluetoothLE.Net.Parsers.Types {
    ...
    public class UInt48 : IComparable, IComparable<UInt48>, IConvertible, IEquatable<UInt48>, IFormattable {
        ...
        #region overrides
        public override bool Equals(object? obj) => obj is UInt48 @int && this.Equals(@int);
        ...
        public int CompareTo(object? obj) {
            return this.CompareTo(obj as UInt48);
        }
        #endregion
        ...
        public bool Equals(UInt48? other) => other is not null && this.Value == other.Value;
