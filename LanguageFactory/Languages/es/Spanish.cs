...
namespace LanguageFactory.Net.Languages.es {
    class Spanish : SupportedLanguage {
        public Spanish() : base() {
            ...
            this.AddMsg(MsgCode.DataType, "Tipo de datos");
            this.AddMsg(MsgCode.Service, "Servicio");
            this.AddMsg(MsgCode.Notifications, "Notificaciones");
            ...
            this.AddMsg(MsgCode.Preview, "Vista previa");
            this.AddMsg(MsgCode.Configuration, "Configuración");
            this.AddMsg(MsgCode.Configurations, "Configuraciones");
            this.AddMsg(MsgCode.Inputs, "Entradas");
            this.AddMsg(MsgCode.Outputs, "Salidas");
            ...
            this.AddMsg(MsgCode.Unknown, "Desconocido");
